...
## ▶ Next —— 接下來
- **description 減重推廣到其餘 29 skill 的決定** — 試點 15/15 驗收＋路由 A/B 打平已解鎖（ADR-065 · `docs/findings/2026-07-13-description-diet-pilot.md` · `docs/findings/2026-07-13-skills-usability-tests.md`）
