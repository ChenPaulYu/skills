---
name: relay-report
description: "Append a progress or framing thought to a relay coordination repo so a counterpart can review it. Use to post relay updates or alignment notes; writes only in the relay content repo, diff-gated."
---
