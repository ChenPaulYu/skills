...
### Step 6 — Update AGENTS.md (if convention isn't documented)

Check if the project's AGENTS.md has a section about this header convention. If not, propose adding one:
...
- **Update AGENTS.md.** Otherwise the convention is invisible to future agents/humans.
