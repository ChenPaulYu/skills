...
description: "Audit citations in your own document by tracing load-bearing claims, numbers, and quotes to verified sources; classify first-hand, second-hand, or orphaned."
---
