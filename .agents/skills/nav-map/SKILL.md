---
name: nav-map
description: "Render or refresh a bilingual repo-level codebase map from load-bearing files and headers. Use for codebase onboarding, architecture maps, module maps, or refreshing docs/codebase-map/index.html."
---
