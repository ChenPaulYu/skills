---
name: nav-map
description: "Render or refresh a bilingual repo map from load-bearing files and headers. Use for architecture maps; use nav-tour for conversational onboarding."
---
