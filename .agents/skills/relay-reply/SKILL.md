---
name: relay-reply
description: "Respond on an existing GitHub object with input, acceptance, an answer, comment, PR Comment, Approve, or Request changes. Never closes the object."
---
