---
name: relay-reply
description: "Respond on an existing GitHub object with requested input, acceptance, an answer, comment, PR Comment, Approve, or Request changes. Never declares the object finished."
---
