---
name: relay-review
description: "Respond to a relay thought with acknowledgment, agreement, comment, or requested change by appending a linked thought. Use for relay review or approval; writes one diff-gated response."
---
