---
name: shape-baton
description: "Take or pass the session baton: one overwritten cursor of goal, done, now, open, next. Take it on arrival; pass it before stepping away. Explicitly invoked; not align's durable record."
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/shape/skills/baton/ — do not hand-edit; re-run the generator. -->
