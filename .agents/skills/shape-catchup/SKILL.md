---
name: shape-catchup
description: "Reconstruct where this project's work stopped and what comes next from its handoff and current evidence. Explicitly invoked; not a repo tour or permission to start implementing."
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/shape/skills/catchup/ — do not hand-edit; re-run the generator. -->
