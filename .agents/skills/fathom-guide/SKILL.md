---
name: fathom-guide
description: "Teach an unfamiliar repository level by level (Repository to Code), dwelling for questions and gating on the learner own narration. Resumes from a cursor on disk."
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/fathom/skills/guide/ — do not hand-edit; re-run the generator. -->
