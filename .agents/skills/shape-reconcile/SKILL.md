...
description: "Compare blueprints thoughts, plans, and mockups with shipped reality, then propose per-file amend, consolidate, graduate, retire, or prune actions. Read-only until each write is approved."
---
