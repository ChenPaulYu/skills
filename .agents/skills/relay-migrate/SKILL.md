---
name: relay-migrate
description: "Migrate pre-model coordination state into Accord memory while preserving provenance. Explicitly invoked, mapping-first, idempotent, and write-gated."
---
