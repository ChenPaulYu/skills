...
Dispatched item agents (serial or the parallel tail) default to cheap tier (`model: sonnet`); a judgment-dense single item can be escalated on the spot (see root AGENTS.md's Dispatch tiers).
