---
name: frame-draw
description: "Decide how to picture something already understood: which form the question asks for, and which medium carries it (terminal, markdown, mermaid, interactive). Owns the strategy, not one format."
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/frame/skills/draw/ — do not hand-edit; re-run the generator. -->
