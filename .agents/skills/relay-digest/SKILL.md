---
name: relay-digest
description: "Show the viewer's real GitHub obligations: assigned work, review/re-review, settlement, and requesting a reviewer for an unreviewed PR. Read-only; mentions are non-binding notices."
---
