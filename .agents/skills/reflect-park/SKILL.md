---
name: reflect-park
description: "Write the session's cursor (goal, done, now, open, next, plus the current git SHA) into HANDOFF.md before stepping away, overwriting any prior file. Use to hand off work; explicitly invoked on Codex."
