---
name: shape-survey
description: "Map a decision space into independent axes grounded in the real repo, then report the diff versus what the user already knows. Use before deciding in unfamiliar terrain, not for repo maps or external research."
---
