...
description: "Factor a tangled problem into independent axes and verify that changing one does not move the others. Use to disentangle concerns, test orthogonality, or expose conflated dimensions."
---
