...
description: "Put a forming claim on trial: steelman both sides, expose the load-bearing assumption, and name a deciding experiment. Use for devil's advocate, strongest case for/against, or stress-testing a thesis."
---
