---
name: relay-launch
description: "Scaffold a relay coordination project and roster, or add a person and assign their role. Use to create a relay project, register, onboard, or role-assign a teammate; writes relay.yml/project.yml behind a diff gate."
---
