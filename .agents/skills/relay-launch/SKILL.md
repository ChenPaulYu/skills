---
name: relay-launch
description: "Scaffold a relay coordination project and, when needed, its repository roster. Use to create a relay project or workspace; writes project.yml, thoughts/, and decisions/ behind a diff gate."
---
