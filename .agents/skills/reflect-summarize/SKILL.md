...
model: sonnet
description: "Produce a complete, neutral, chronological recap of what this session attempted, decided, changed, and committed. Use for full session summaries; read-only and not a selective learning distillation."
disable-model-invocation: true
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/reflect/skills/summarize/ — do not hand-edit; re-run the generator. -->
