---
name: nav-do
description: "Implement a small, decided, behavior-changing code change without creating a plan artifact. Use for quick features or small fixes; not for behavior-preserving refactors or large/spec-ambiguous work."
---
