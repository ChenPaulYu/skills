...
description: "Surface durable learning candidates, let the user choose, then write only selected observations or scrubbed skill feedback. Use to preserve learning."
---
