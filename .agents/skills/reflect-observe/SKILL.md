---
name: reflect-observe
description: "Surface this session's candidate durable learnings, let the user choose, then write only selected observations or skill feedback. Use to record insights or decide what is worth preserving."
disable-model-invocation: true
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/reflect/skills/observe/ — do not hand-edit; re-run the generator. -->
