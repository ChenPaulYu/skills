---
name: relay-settle
description: "Distill agreed relay thoughts into the append-only decision ledger and regenerate the active decisions view. Use to settle, crystallize, pin, or log project decisions; never deletes or moves thoughts."
---
