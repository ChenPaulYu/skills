---
name: reflect-catchup
description: "Reconstruct the current state of work from git, diffs, files, plans, and live context. Use for 'where are we?', resuming after a break, or getting oriented; read-only and focused on present state."
disable-model-invocation: true
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/reflect/skills/catchup/ — do not hand-edit; re-run the generator. -->
