...
description: "Reconstruct the current state of work from git, diffs, files, plans, and live context. Use for 'where are we?', resuming after a break, or getting oriented; read-only, present-state only."
