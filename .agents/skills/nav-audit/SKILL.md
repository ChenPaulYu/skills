---
name: nav-audit
description: "Read-only codebase architecture audit against deep-module principles. Use for health reviews, architectural smells, feature-readiness checks, or thorough domain sweeps; reports findings, no code change."
---
