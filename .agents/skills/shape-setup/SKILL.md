---
name: shape-setup
description: "Scaffold a new project to a verified running baseline using an archetype or grounded exemplar, with staged commits and verification. Use to start repos or projects, not to add features."
---
