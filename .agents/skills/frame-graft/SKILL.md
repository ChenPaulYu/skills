---
name: frame-graft
description: "Design by mapping every primitive of a mature donor model onto a new problem, classifying fit, break, and adapt. Use when reasoning through another system's structure or mapping X onto Y."
---
