---
name: frame-graft
description: "Design by mapping every primitive of a mature donor model onto a new problem, classifying fit, break, and adapt. Use when asked to reason through another system's structure or map X onto Y."
---
<!-- GENERATED by scripts/build-codex.mjs from plugins/frame/skills/graft/ — do not hand-edit; re-run the generator. -->
