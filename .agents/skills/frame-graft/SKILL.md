---
name: frame-graft
description: "Map every primitive of a mature donor model onto a new problem, classifying fit, break, and adapt. Use to design through another system's structure."
---
