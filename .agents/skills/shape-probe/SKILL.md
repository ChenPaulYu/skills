---
name: shape-probe
description: "Design and run a minimal experiment (A/B, blind judgment test, or behavior probe) when a fork can't be settled by argument. Use to test an undecided claim, not for preference or friction."
---
