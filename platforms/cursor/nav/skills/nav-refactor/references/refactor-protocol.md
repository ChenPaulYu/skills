...
After Step 7's report, present next-action options via `AskQuestion`. The discipline ("don't commit / don't improve in this session") is preserved by the question — the user picks; nothing happens unless they do.
