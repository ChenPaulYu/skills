...
> **Interactive choice contract (Cursor).** Do not force an end-of-turn next-action menu. If the user already authorized a scoped action, continue within that scope without asking them to choose again.
>
