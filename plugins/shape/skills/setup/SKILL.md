---
name: setup
description: "Scaffold a new project to a verified running baseline — archetype-driven, principles-consistent, gotcha-aware: preflights the toolchain, scaffolds, verifies, and commits in stages. Done means the verification chain is green, not files written. NOT for generating CLAUDE.md (use /init), scaffolding blueprints (use /shape:align), or adding features (use /nav:do or /shape:build). A new archetype with no reference enters exemplar mode, grounding on a living repo."
