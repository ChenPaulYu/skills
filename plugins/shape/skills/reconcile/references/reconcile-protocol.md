...
scaffolds it) rather than inventing one (tolerant-reader degrade path, root CLAUDE.md /
...
auto-call — `/shape:align`** to refresh it, via `AskUserQuestion` (offer-next-action,
