...
6. **Offer the next step (don't auto-run).** After landing the thought, *offer* — never auto-call — the natural continuation via `AskUserQuestion` (offer-next-action, ADR-007/015). Two branches, composed from what the grill actually surfaced:
