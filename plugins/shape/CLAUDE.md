...
Seven skills built (`mockup`, `elicit`, `dogfood`, `position`, `align`, `reconcile`, `build`); `doctor` (orchestrator) deferred until the family proves out. `elicit`'s behavioral spec comes from `docs/observations/2026-05-29-thought-mode-how-paul-converges.md`; `build` + the browser-verify slot land in ADR-011; `position` lands in ADR-035. History: `docs/observations/2026-05-29-shape-plugin.md`.
