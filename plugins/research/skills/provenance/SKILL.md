---
name: provenance
description: "Audit your OWN documents' citations — trace every load-bearing number, quote, and \"X showed Y\" back to a verified source; classify each as first-hand verified / second-hand / orphan; produce a quarantine list (read-or-demote before relying on the document). The mirror of /research:critique: critique audits THEIR claims against THEIR evidence; provenance audits YOUR use of theirs. Use before a submission, a decision, or any moment a document is about to be relied on. Fires on \"are my citations sound\", \"check my sources\", \"which claims haven't we verified\", \"does every number have an origin\", \"sweep for unread citations\", \"provenance check\", \"audit my references\". Repair arm: each suspect finding hands off to /research:dissect (forensic mode) to verify cited-as vs actually-says. For assessing an external paper's own argument, use /research:critique; for understanding one document, /research:dissect."
---
