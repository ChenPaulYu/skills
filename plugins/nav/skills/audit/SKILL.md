---
name: audit
description: "Audit a codebase against deep-module principles (Ousterhout's \"A Philosophy of Software Design\"). Language-agnostic with stack heuristics. Two modes: (1) Health audit on \"audit my codebase\", \"review the architecture\", \"is this a deep module?\", \"what's wrong with this codebase?\", \"any architectural smells?\", \"do a full sweep/checkup\"; (2) Feasibility check on \"can this codebase support feature X?\", \"is this code ready for Y?\", \"does our architecture fit this plan?\". Fires on modularity/progressive disclosure discussions. Read-only findings; to act, use /nav:sync, /nav:map, or /nav:refactor. For full spec planning, use /nav:plan."
---
